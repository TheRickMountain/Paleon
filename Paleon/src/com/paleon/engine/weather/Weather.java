...
public class Weather {
	...
	private WeatherFrame[] weatherFrames = {
			new WeatherFrame(0, new Color(0.05f, 0.05f, 0.1f), new Color(0.05f, 0.05f, 0.16f)),
			new WeatherFrame(2500, new Color(0.05f, 0.05f, 0.1f), new Color(0.05f, 0.05f, 0.16f)),
			new WeatherFrame(3500, new Color(0.77f, 0.58f, 0.6f), new Color(1.0f, 0.4f, 0.6f)),
			new WeatherFrame(7500, new Color(0.96f, 0.96f, 0.81f), new Color(1f, 0.9f, 0.8f)),
			new WeatherFrame(12000, new Color(1.0f, 1.0f, 0.96f), new Color(1f, 0.9f, 0.8f)),
			new WeatherFrame(16500, new Color(0.96f, 0.96f, 0.816f), new Color(1f, 0.9f, 0.8f)),
			new WeatherFrame(21000, new Color(0.77f, 0.58f, 0.6f), new Color(1.0f, 0.4f, 0.6f)),
			new WeatherFrame(23500, new Color(0.05f, 0.05f, 0.1f), new Color(0.05f, 0.05f, 0.16f)),
			new WeatherFrame(24001, new Color(0.05f, 0.05f, 0.1f), new Color(0.05f, 0.05f, 0.16f)),
	};
